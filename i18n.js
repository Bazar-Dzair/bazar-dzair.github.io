...
(function (global) {
  ...
  var UI_DICT = {
    ...
    latest_products_title:      { ar: "وصل حديثًا",                      fr: "Nouveautés" },
    latest_products_subtitle:   { ar: "اكتشف آخر المنتجات المضافة إلى متجرنا", fr: "Découvrez les derniers articles ajoutés à notre boutique" },
    badge_new:                  { ar: "جديد",                              fr: "NOUVEAU" },
    wish_add:                   { ar: "إضافة إلى المفضلة",                 fr: "Ajouter aux favoris" },
    wish_remove:                { ar: "إزالة من المفضلة",                  fr: "Retirer des favoris" },
    toast_wish_added:           { ar: "أُضيف إلى المفضلة ❤️",              fr: "Ajouté aux favoris ❤️" },
    toast_wish_removed:         { ar: "أُزيل من المفضلة",                  fr: "Retiré des favoris" },
    carousel_prev:              { ar: "السابق",                            fr: "Précédent" },
    carousel_next:              { ar: "التالي",                            fr: "Suivant" },
    carousel_page:              { ar: "الانتقال إلى المجموعة",             fr: "Aller à la page" },

    home_why_title:         { ar: "لماذا تختار Bazar Dzair؟", fr: "Pourquoi choisir Bazar Dzair ?" },
    benefit_service_title: { ar: "خدمة العملاء",     fr: "Service client" },
    benefit_service_desc:  { ar: "نحن في خدمتك قبل وبعد الطلب.", fr: "À votre service avant et après la commande." },
    benefit_genuine_title: { ar: "منتجات مختارة",   fr: "Produits sélectionnés" },
    benefit_genuine_desc:  { ar: "نختار المنتجات بعناية قبل عرضها.",     fr: "Nous sélectionnons chaque produit avec soin avant de le proposer." },
    benefit_delivery_title:{ ar: "توصيل 58 ولاية",      fr: "Livraison dans les 58 wilayas" },
    benefit_delivery_desc: { ar: "نوصل طلبك لباب دارك حسب منطقة التوصيل.", fr: "Nous livrons votre commande jusqu'à votre porte selon la zone de livraison." },
    benefit_cod_title:     { ar: "الدفع عند الاستلام", fr: "Paiement à la livraison" },
    benefit_cod_desc:      { ar: "تدفع عند استلام طلبك.", fr: "Vous payez à la réception de votre commande." },

    trust_title:            { ar: "لماذا يثق بنا الزبائن؟ 🤝", fr: "Pourquoi nos clients nous font confiance ? 🤝" },
    trust_subtitle:         { ar: "شفافية كاملة في كل خطوة من طلبك", fr: "Une transparence totale à chaque étape de votre commande" },
    trust_reviews_title:    { ar: "تقييمات زبائننا", fr: "Avis de nos clients" },
    trust_reviews_desc:     { ar: "[ضعي هنا تقييمات حقيقية من زبائنك — مثلاً منسوخة من محادثات واتساب بعد وصول الطلب]", fr: "[Ajoutez ici de vrais avis de vos clients — par exemple copiés depuis WhatsApp après la livraison]" },
    trust_orders_title:     { ar: "طلبات تم توصيلها بنجاح", fr: "Commandes livrées avec succès" },
    trust_orders_placeholder:{ ar: "[ضعي هنا رقمًا حقيقيًا]", fr: "[Indiquez ici un chiffre réel]" },
    trust_carriers_title:   { ar: "شركاء التوصيل", fr: "Partenaires de livraison" },
    trust_carriers_desc:    { ar: "نعمل مع Noest وDHD لتوصيل طلباتك بأمان إلى جميع الولايات", fr: "Nous travaillons avec Noest et DHD pour livrer vos commandes en toute sécurité dans toutes les wilayas" },
    trust_returns_title:    { ar: "استبدال واسترجاع واضح", fr: "Échange et retour clairs" },
    trust_returns_desc:     { ar: "يمكنك إلغاء طلبك قبل شحنه، والتواصل معنا لاسترجاع أو استبدال أي منتج غير مطابق", fr: "Vous pouvez annuler votre commande avant expédition, et nous contacter pour retourner ou échanger tout produit non conforme" },
    trust_contact_title:    { ar: "تواصل مباشر معنا", fr: "Contactez-nous directement" },
    trust_whatsapp:         { ar: "واتساب", fr: "WhatsApp" },
    ...
    detail_buy_now:    { ar: "⚡ اطلب الآن",               fr: "⚡ Commander" },
